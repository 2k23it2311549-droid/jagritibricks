    ...
    return (
        <div className="dora-fade-in">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
                ...
                <button
                    onClick={() => openModal()}
                    className="bg-gradient-to-r from-orange-500 to-red-600 text-white px-6 py-3 rounded-full font-bold shadow-lg flex items-center gap-2 group hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
                >
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input name="min_order_qty" type="number" value={formData.min_order_qty} onChange={handleInputChange} className="mt-1 w-full border rounded p-2" required />
                                </div>
                                <div>
                            ...
                            <div>
                                ...
                                <div className="mt-1 flex items-center space-x-4">
                                    ...
                                    <input
                                        ...
                                        disabled={uploading}
                                    />
                                    {uploading && <span className="text-sm text-orange-500 animate-pulse">Uploading...</span>}
                                </div>
                            </div>
                            ...
                            <div className="flex justify-end space-x-3 mt-6 pt-4 border-t">
                                ...
                                <button type="submit" disabled={uploading} className="px-6 py-2 bg-gradient-to-r from-orange-500 to-red-600 text-white rounded-lg hover:shadow-lg disabled:opacity-50 transition-all duration-300 transform hover:scale-105">Save Product</button>
                            </div>
                        </form>
                    </div>
                </div>
