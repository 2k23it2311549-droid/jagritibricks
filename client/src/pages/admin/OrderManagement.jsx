        ...
        <AdminLayout title="Order Management">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div className="flex items-center space-x-3 w-full md:w-auto overflow-x-auto">
                        ...
                        <button
                            ...
                            className="flex items-center px-4 py-2 bg-brand-red text-white rounded-lg hover:bg-red-700 transition font-medium shadow-sm whitespace-nowrap"
                        >
                            <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="space-y-4">
                ...
                {filteredOrders.map((order) => (
                    <div key={order.id} className={`bg-white rounded-xl shadow-sm overflow-hidden border transition-all hover:shadow-md ${selectedOrders.includes(order.id) ? 'border-brand-red ring-1 ring-brand-red/10' : 'border-gray-100'}`}>
